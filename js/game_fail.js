...
var Game = {
    ...
    createPlayer : function() {
        player=game.add.sprite(300,game.height-50,'player');
       ...
       player.y=game.world.height-player.height;
        ...
        player.body.dynamic=false;
        player.body.onBeginContact.add(this.collisionHandler, this);
    },

    createCoins : function () {
        // var coin=coins.create(1220,game.rnd.realInRange((game.world.height/3),(game.world.height-150)), 'coin', 0);
            var coin=coins.create(1220,game.height-30, 'coin', 0);
...
collisionHandler :function (body, bodyB, shapeA, shapeB, equation) {
